    ...
    <div class="login-box center-align">
        ...
        <form class="form">
            ...
            <div class="center-align">
                <button v-on:click="confirm($event)" class="btn btn-default btn-large">Verify Now</button>
            </div>
        </form>
    </div>
</template>
...
export default {
    ...
    methods: {
        confirm (event) {
            ...
            this.$cognitoAuth.confirmRegistration(this.username, this.confirmcode, (err,) => {
                if (err) {
                    this.error = err
                } else {
